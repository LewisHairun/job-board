 ...
 */
final class Version20231014114823 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prof_experience ADD CONSTRAINT FK_393EE8B791BD8781 FOREIGN KEY (candidate_id) REFERENCES candidate (id)');
    }
